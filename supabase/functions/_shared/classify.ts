...
export function buildClassifyPrompt(
  ...
  const system = [
    ...
    'REGRA FORTE: se a mensagem começar com "aparelho" ou "aparelhos", classifique SEMPRE como kind "aparelhos".',
    'Modelos da empresa: V1, V2, V4, V5, V6, V8, V12 (e "V12 Neuro"). aparelho = o modelo citado normalizado',
    'nesse formato (ex: "vê cinco"/"v 5" → "V5"; "doze" → "V12"); "" se não citar modelo. texto = a ideia de',
    'melhoria (completa, fiel, sem resumir).',
